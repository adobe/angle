...
#ifndef COMPILER_CSSSHADERS_REWRITE_CSS_FRAGMENT_SHADER
#define COMPILER_CSSSHADERS_REWRITE_CSS_FRAGMENT_SHADER
...
#endif  // COMPILER_CSSSHADERS_REWRITE_CSS_FRAGMENT_SHADER
